...
@SolverFactory.register(
    "_scip_shell", doc="Shell interface to SCIP - Solving Constraint Integer Programs"
)
class SCIP_Shell(SystemCallSolver):
    ...
    def _default_executable(self):
        ...
        if not executable:
            msg = (
                "Could not locate the 'scip' executable, which is "
        ...
        with open(self._soln_file, "r") as f:
            ...
            for line in f:
                ...
                if m is not None:
                    ...
                    logger.error(
                        f'Unexpected line "{line}" while parsing {self._soln_file}'
                    )
